...
class PythonTransform:
    ...
    config = {
        'OPEN_NUMBER':       '<font color="#0080C0">',
        'CLOSE_NUMBER':      '</font>',
        'OPEN_OP':           '<font color="#0000C0">',
        'CLOSE_OP':          '</font>',
        'OPEN_STRING':       '<font color="#004080">',
        'CLOSE_STRING':      '</font>',
        'OPEN_COMMENT':      '<font color="#008000">',
        'CLOSE_COMMENT':      '</font>',
        'OPEN_NAME':         '<font color="#000000">',
        'CLOSE_NAME':        '</font>',
        'OPEN_ERRORTOKEN':   '<font color="#FF8080">',
        'CLOSE_ERRORTOKEN':  '</font>',
        'OPEN_KEYWORD':      '<font color="#C00000">',
        'CLOSE_KEYWORD':     '</font>',
        'OPEN_TEXT':         '',
        'CLOSE_TEXT':        '',
        }
